import"./modulepreload-polyfill-3cfb730f.js";import{V as l,a as d,M as s}from"./three-tile-7bc2cf71.js";import{c as m,a as x}from"./util-9e737be5.js";import{m as F,a as $}from"./mapSource-e50c2872.js";const a=m($,F),p=new l(108,34,0),g=new l(108,0,1e4),i=x("#map",a,p,g);i.controls.saveState();function f(o,c){const e=new d;o.container.addEventListener("pointermove",n=>{e.x=n.clientX/o.renderer.domElement.clientWidth*2-1,e.y=-(n.clientY/o.renderer.domElement.clientHeight)*2+1;const t=c.getLocalInfoFromScreen(o.camera,e);if(t){const r=document.querySelector("#local-info");r.innerHTML=`经度:${t.location.x.toFixed(6)}°  
