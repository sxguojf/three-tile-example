import"./modulepreload-polyfill-3cfb730f.js";import{V as a,m as d,a as l,x,b as f}from"./mapSource-2c762b60.js";import{c as F,a as $}from"./util-e741174c.js";const c=F([l,x],d),m=c.geo2pos(new a(108.95,34.2)),p=new a(m.x,m.y,0),g=new a(0,-50,40),i=$("#map",p,g);i.scene.add(c);function u(o,n){const e=new f;o.container.addEventListener("pointermove",r=>{e.x=r.clientX/o.renderer.domElement.clientWidth*2-1,e.y=-(r.clientY/o.renderer.domElement.clientHeight)*2+1;const t=n.getLocalInfoFromScreen(o.camera,e);if(t){const s=document.querySelector("#local-info");s.innerHTML=`经度:${t.location.x.toFixed(2)}°  
