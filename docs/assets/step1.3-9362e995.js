import"./modulepreload-polyfill-3cfb730f.js";import{V as d,m as l,a as m,b as x,d as s}from"./mapSource-1769961f.js";import{c as F,a as $}from"./util-a377a475.js";const e=F(m,l),p=new d(108,34,0),g=new d(108,0,1e4),r=$("#map",e,p,g);r.scene.add(e);r.controls.saveState();function f(o,c){const n=new x;o.container.addEventListener("pointermove",a=>{n.x=a.clientX/o.renderer.domElement.clientWidth*2-1,n.y=-(a.clientY/o.renderer.domElement.clientHeight)*2+1;const t=c.getLocalInfoFromScreen(o.camera,n);if(t){const i=document.querySelector("#local-info");i.innerHTML=`经度:${t.location.x.toFixed(6)}°  
