import"./modulepreload-polyfill-3cfb730f.js";import{g as C,I as Z,V as g,J as _,K as T,s as M,b as z,L as $,N as q,U as k,X as Q,Y as ee,Z as R,_ as te,T as ie,$ as ne,m as oe,a as se}from"./mapSource-1769961f.js";import{g as re}from"./lil-gui.module.min-a1e98589.js";import{c as ae,a as le,e as ce,b as ue,s as ve}from"./util-a377a475.js";class x extends C{constructor(){super(x.Geometry,new Z({opacity:0,transparent:!0})),this.isLensflare=!0,this.type="Lensflare",this.frustumCulled=!1,this.renderOrder=1/0;const i=new g,a=new g,s=new _(16,16),e=new _(16,16);let U=k;const c=x.Geometry,P=new T({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
