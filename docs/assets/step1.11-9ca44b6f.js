import"./modulepreload-polyfill-3cfb730f.js";import{Q as l,M as d,V as m,s as F,t as $,b as g,d as s}from"./mapSource-50ea1ccb.js";import{c as p,a as u}from"./util-0d1e0617.js";const x=[108.60157012939453,30.64670562744141,108.65313291549683,30.69008231163025],y=new l.MapBoxSource({token:d,dataType:"image",style:"mapbox.satellite",bounds:x}),f=new l.MapBoxSource({token:d,dataType:"terrain-rgb",style:"mapbox.terrain-rgb",maxLevel:15,bounds:x}),a=p([y,$],f),L=new m(108.627984,30.66284,0),b=new m(108.627139,30.64138,3.309163),r=u("#map",a,L,b);r.scene.background=new F(0);function M(o,c){const e=new g;o.container.addEventListener("pointermove",n=>{e.x=n.clientX/o.renderer.domElement.clientWidth*2-1,e.y=-(n.clientY/o.renderer.domElement.clientHeight)*2+1;const t=c.getLocalInfoFromScreen(o.camera,e);if(t){const i=document.querySelector("#local-info");i.innerHTML=`经度:${t.location.x.toFixed(2)}°  
