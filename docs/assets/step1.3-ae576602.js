import"./modulepreload-polyfill-3cfb730f.js";import{V as l,m as d,a as m,b as x,c as s}from"./mapSource-8cec7301.js";import{c as F,a as $}from"./util-202ae443.js";const c=F(m,d),p=new l(108,34,0),g=new l(108,0,1e4),i=$("#map",c,p,g);i.controls.saveState();function f(o,a){const e=new x;o.container.addEventListener("pointermove",n=>{e.x=n.clientX/o.renderer.domElement.clientWidth*2-1,e.y=-(n.clientY/o.renderer.domElement.clientHeight)*2+1;const t=a.getLocalInfoFromScreen(o.camera,e);if(t){const r=document.querySelector("#local-info");r.innerHTML=`经度:${t.location.x.toFixed(6)}°  
