import"./modulepreload-polyfill-3cfb730f.js";import{e as C,J as Z,V as c,K as k,L as T,r as M,b as z,N as $,Q as q,U as G,Z as ee,_ as te,$ as R,a0 as ie,T as ne,a1 as oe,m as se,a as re}from"./mapSource-6ce90261.js";import{g as ae}from"./lil-gui.module.min-a1e98589.js";import{c as le,a as ce,d as ue,b as ve,s as pe}from"./util-f7379211.js";class x extends C{constructor(){super(x.Geometry,new Z({opacity:0,transparent:!0})),this.isLensflare=!0,this.type="Lensflare",this.frustumCulled=!1,this.renderOrder=1/0;const i=new c,a=new c,r=new k(16,16),e=new k(16,16);let U=G;const u=x.Geometry,P=new T({uniforms:{scale:{value:null},screenPosition:{value:null}},vertexShader:`
