...
const exampleList = {
	...
	"step1.11": {
		label: "1.11 起步-自定义区域瓦片测试",
	},
	"step1.12": {
		label: "1.12 起步-防止摄像机穿过地面",
	},
	"step1.13": {
		label: "1.13 起步-鼠标点击放置模型到地面",
	},
	...
	"step4.1": {
		label: "4.1 扩展-自定义加载器1",
	},
	"step4.2": {
		label: "4.2 扩展-自定义加载器2",
	},
	"step4.3": {
		label: "4.3 扩展-自定义加载器3",
	},
	"step4.4": {
		label: "4.4 扩展-自定义加载器4",
	},
	"step4.5": {
		label: "4.5 扩展-自定义加载器5",
	},
	"step4.6": {
